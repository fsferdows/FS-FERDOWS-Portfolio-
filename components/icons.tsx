...
export const BrainCircuitIcon: React.FC<IconProps> = ({ size = 24, className }) => (
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        width={size} 
        height={size} 
        ...
        className={className}
    >
        <path d="M12 5a3 3 0 1 0-5.993.134M12 5a3 3 0 1 1 5.993.134M12 19a3 3 0 1 0-5.993-.134M12 19a3 3 0 1 1 5.993.134M20 12a3 3 0 1 0-5.993.134M4 12a3 3 0 1 1 5.993.134M12 5v14M5 12H2m17 0h3"/>
    </svg>
);
...
export const BookOpenIcon: React.FC<IconProps> = ({ size = 24, className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const RefreshIcon: React.FC<IconProps> = ({ size = 24, className }) => (
  <svg
    ...
    className={className}
  >
    <path d="M21.5 2v6h-6M2.5 22v-6h6M2 12a9 9 0 0 1 15-6.7L21.5 8M22 12a9 9 0 0 1-15 6.7L2.5 16" />
  </svg>
);
...
export const TrophyIcon: React.FC<IconProps> = ({ size = 24, className }) => (
    ...
    >
        ...
        <path d="M12 2a5 5 0 0 0-5 5v5h10V7a5 5 0 0 0-5-5z"></path>
    </svg>
);
...
export const GraduationCapIcon: React.FC<IconProps> = ({ size = 24, className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const CommandIcon: React.FC<IconProps> = ({ size = 24, className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const WandIcon: React.FC<IconProps> = ({ size = 24, className }) => (
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        width={size} 
        height={size} 
